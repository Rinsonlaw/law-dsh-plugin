...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.gg-count-text{flex:1;display:flex;align-items:center;padding:0 12px 0 10px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
      '.gg-flow-badge{flex:none;display:inline-flex;align-items:center;padding:0 12px 0 8px;font-size:10px;font-weight:600;color:#fff;align-self:stretch;clip-path:polygon(0 0,calc(100% - 7px) 0,100% 50%,calc(100% - 7px) 100%,0 100%)}',
