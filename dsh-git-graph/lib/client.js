...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.gg-btn:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.06))}',
      ...
      '.gg-row:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.05))}',
      '.gg-row.sel{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.08));border-left-color:var(--dsw-alias-state-business-primary,#4c8dff)}',
      ...
      '.gg-ref-branch{background:var(--dsw-alias-state-success-primary,rgba(46,160,67,.25));color:var(--dsw-alias-state-success-primary,#3fb950)}',
      '.gg-ref-tag{background:rgba(210,153,34,.22);color:#e3b341}',
      '.gg-ref-remote{background:rgba(88,166,255,.18);color:#79b8ff}',
      ...
      '.gg-toggle:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.06));color:var(--dsw-alias-label-primary,#e6e6e6)}',
      // floating overlay
      ...
      '.gg-close:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(255,255,255,.06))}',
    ].join('\n')
