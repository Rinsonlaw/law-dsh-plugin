...
function graphHtml(rows, maxCol, rowOf, colorOf, selectedHash, dirty = 0) {
  ...
  return head + rows.map((c, i) => {
    ...
    const CSS = [
      ...
      '.gg-count-line{flex:none;display:flex;align-items:center;padding:0 12px 0 8px;height:28px;font-size:11px;color:var(--dsw-alias-label-tertiary,#8b94a7);border-bottom:1px solid var(--dsw-alias-border-l1,rgba(255,255,255,.06));position:sticky;top:0;background:var(--dsw-alias-bg-base,#0f1115);z-index:1}',
      '.gg-count-text{flex:1;display:flex;align-items:center;padding:0 0 0 28px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}',
